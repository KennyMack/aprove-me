export class Fails {
  ...
  static INVALID_DOCUMENT = 'CPF/CNPJ informado não é valido.';
  static INVALID_EMAIL = 'E-mail informado não é valido.';
  static INVALID_PHONE = 'Telefone informado não é valido.';
  static INVALID_EMISSIONDATE = 'Data de emissâo informada não é valida.';
  static PAYMENTVALUE_MUSTBE_GREATERTHANZERO =
